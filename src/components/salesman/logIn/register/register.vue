<template>
  <div>
    ...
    <div class="header">
      <img src="../../../../images/index/logo-min.png" alt="">
      <div>
    ...
    <div class="form_container">
      ...
      <div class="form_each">
        <div class="input_label"><span class="redStar">*</span>手机号</div>
        <input type="text" class="inputBox" v-model="registerData.phone">
        <div class="clr"></div>
      </div>
      <div class="form_each">
        <div class="input_label"><span class="redStar">*</span>验证码</div>
        <input type="text" class="inputBox" v-model="registerData.yg_code">
        <div class="clr"></div>
        <button :class="{getCode:getPassword == false}" @click="GetPassword" v-if="!getPassword">获取验证码</button>
        <button :class="{getCode1:getPassword == true}" @click="GetPassword" v-else>{{sec}}s后重发</button>
      </div>
      <div class="form_each" v-if="!this.showPassword">
        <div class="input_label"><span class="redStar">*</span>密码</div>
        <input type="password" class="inputBox" v-model="registerData.password">
        <div class="showPassword" @click="changePasswordShow">
          <img src="../../../../images/salesman/eye.png" alt="">
        </div>
        <div class="clr"></div>
      </div>
      <div class="form_each" v-if="this.showPassword">
        <div class="input_label"><span class="redStar">*</span>密码</div>
        <input type="text" class="inputBox" v-model="registerData.password">
        <div class="showPassword" @click="changePasswordShow">
          <img src="../../../../images/salesman/eye2.png" alt="">
        </div>
        <div class="clr"></div>
      </div>
      <div class="form_each">
      ...
      <div class="form_each">
        ...
        <!--<input type="text" class="inputBox" v-model="registerData.city">-->
      ...
      <div class="form_each">
        ...
        <!--<input type="text" class="inputBox" v-model="registerData.birthday">-->
        <el-date-picker class="select3"
      ...
      <div class="form_each">
        <button class="submitButton" @click="submit">注册</button>
      </div>
    </div>
    ...
    methods:{
          ...
          for (let i = 0; i <= 60; i++) {
            window.setTimeout(function () {
              if (that.sec != 0) {
                ...
                that.sec = 60;//如果倒计时结束就让  获取验证码显示出来
      ...
      submit(){
        ...
        params = {
          ...
          code: this.registerData.yg_code,
          password: strPwd,
        ...
        console.log(params.birthday,typeof params.birthday)
        this.global.axiosPostReq('/saleLog/register',params).then(res =>{
